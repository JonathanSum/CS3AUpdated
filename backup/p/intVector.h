...
private:
    ...
    int *dataInt;          //IN - the address of the array
    double *dataDouble;
    string *dataString;
...
************************/
    ...
    IntVector(unsigned size) {
        ...
        cap = size;
        dataInt = new int[cap];
        dataDouble = new double[cap];
        dataString = new string[cap];
        dataRational = new Rational[cap];
        dataDate = new Date[cap];
        dataComplex = new Complex[cap];
        for (int i = 0; i < sz; i++) {
            dataInt[i]=0;
            dataDouble[i]=0;
            dataString[i]="";
            dataRational[i]=Rational();
            dataDate[i]=Date();
            dataComplex[i]=Complex();
        }
    };
    ...
    IntVector(unsigned size, int value) {
        ...
        for (int i = 0; i < sz; i++) {
            ...
            dataDouble[i]=0;
            dataString[i]="";
            dataRational[i]=Rational(i,i);
            dataDate[i]=Date();
            dataComplex[i]=Complex(i,i);
        }
    };
    ...
    **********************/
    ...
    //void &at( unsigned index,int type ) const;
