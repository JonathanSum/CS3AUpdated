...
int z=0;
    ...
    cout<<"Should be u "<<text[0].words[8]<<endl;
    Student studentList[classSize];
    cout<<"I am class size "<<classSize<<endl;
    for (int i = 0; i < 8; i++) {
        cout<<"size ";
        cout<<text[i].words.length()<<"% % "<<text[i].words<<endl;
        int nextIndex=text[i].words.length();
        for(int j=0; j<nextIndex; j++){
            cout<<j<<endl;
            cout<<text[i].words[j]<<endl;
        }
