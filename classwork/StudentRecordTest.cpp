...
//                myfile<<"Debug Test Avg: "<<TestAvg<<endl;
        ...
        float a1=73.00;
        cout<<"Debug History avgtest: "<<a1<<endl;
...
//    Student Name (width is 37, left justified) then Test Avg (width is 13, left justified), then Grade
//    Dashed line containing 64 dashes
//    Name (width is 40, left justified), avg (width 8, left justified), grade (width 6, right justified)
//    Class Average (width is 40, left justified), avg (width 8, left justified), grade (width 6, right justified)
