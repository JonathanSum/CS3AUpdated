...
template<class E>
string Iterator<E>::stringAddress() {
...
public:
    ...
    **********************/
    ...
    const E &front() const noexcept;;

    const E &back() const noexcept;

    int length(Iterator<E> head) const;

    int sum(Iterator<E> head) const;
    string stringAddress() const;
    void deleteItem(int position);
    void insertByPosition(int position, E date);
};
...
*****************************************************/
template<class E>
const E &LinkedList<E>::front() const noexcept {
    try {
        if (isEmpty()) {
            ListEmpty empty;
            throw empty;
...
*****************************************************/
template<class E>
const E &LinkedList<E>::back() const noexcept {
    try {
        if (isEmpty()) {
            ListEmpty empty;
            throw empty;
...
int LinkedList<E>::sum(Iterator<E> head) const {
    ...
    E data = *head;       //OUT - the amount in integer of each element
...
*****************************************************/
template<class E>
Iterator<E> LinkedList<E>::begin()const {
...
*****************************************************/
template<class E>
Iterator< E > LinkedList<E>::end()const {
...
*****************************************************/
template<class E>
void LinkedList<E>::pop_front() noexcept {
...
template <class E>
string LinkedList<E>::stringAddress() const {
...
template<class E>
void LinkedList<E>::deleteItem(int position) {
    cout<<position<<endl;
    ...
    if (current == nullptr) {
        cout << "There is no element at position " << position << " in list.\n";
        return;
    ...
    //PROCESSING - deleteing the case that current is not tail or head.
    else {
...
template<class E>
void LinkedList<E>::insertByPosition(int position, E date) {
    if(position == 0){
        push_front(date);
        return;
    }
