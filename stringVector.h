...
#ifndef UNTITLED6_STRINGVECTOR_H
#define UNTITLED6_STRINGVECTOR_H
...
private:
    ...
    string *data;          //IN - the address of the array
public:
...
************************/
    ...
    StringVector(unsigned size, int value) {
        data = nullptr;
    ...
    **********************/
    ...
    /**********************
         * * MUTATORS **
    **********************/
    void insert( unsigned index, string value );
    void erase( unsigned index );
    void push_back( string value );
    void pop_back();
    void clear();
    void resize( unsigned size );
    void resize( unsigned size, string value );
    void reserve( unsigned n );
    void assign( unsigned n, string value );
...
/*********************************************************************
   * StringVector Class
   * This class represents a StringVector object.
...
/*********************************************************************
 *  StringVector(unsigned size);
 *  Constructor;   Sets both the size and capacity of the StringVector
...
#endif //UNTITLED6_STRINGVECTOR_H
